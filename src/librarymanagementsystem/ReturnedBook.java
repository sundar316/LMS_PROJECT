        ...
        try
            {
                ...
                ResultSet rs=st.executeQuery("select bookID as 'Book ID',userID as 'User ID',issueDate as 'Issue Date',dueDate as 'Due Date'from issue where status='1' order by issueDate");
        ...
        try
            {
                Connection con=ConnectionProvider.getCon();
                Statement st=con.createStatement();
                ResultSet rs=st.executeQuery("select bookID as 'Book ID',userID as 'User ID',issueDate as 'Issue Date',dueDate as 'Due Date'from issue where bookID like'%"+search+"%' and status='1' or userID like'%"+search+"%' and status='1' or dueDate like'%"+search+"%' and status='1' or issueDate like'%"+search+"%' and status='1'");
                jTable1.setModel(DbUtils.resultSetToTableModel(rs));
                theader();
            }
            catch(SQLException e)
