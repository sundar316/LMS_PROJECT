...
private void theader()
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            ResultSet rs=st.executeQuery("select bookID as 'BookID',userID as 'User ID',issueDate as 'Issue Date',dueDate as 'Due Date' from issue where status='0' order by issueDate");
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
            ...
            try
        {
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select bookID as 'BookID',userID as 'User ID',issueDate as 'Issue Date',dueDate as 'Due Date' from issue where bookID like'%"+search+"%' and status='0' or userID like'%"+search+"%'and status='0' or issueDate like'%"+search+"%' and status='0' or dueDate like'%"+search+"%' and status='0'");
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
            theader();
        }
        catch(SQLException e)
